...
import { CameraConfig, Circle, CircleOption, GoogleMapConfig, GoogleMapsOptions, LatLng, LatLngBounds, MapPadding, MapType, Marker, MarkerOption, Polygon, PolygonOption, Polyline, PolylineOption, Size, VisibleRegion } from './definitions';
/**
