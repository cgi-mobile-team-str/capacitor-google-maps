...
export class CapacitorGoogleMapsWeb extends WebPlugin implements CapacitorGoogleMapsPlugin {
  protected gMapsRef: typeof google.maps | undefined = undefined;
  protected AdvancedMarkerElement: typeof google.maps.marker.AdvancedMarkerElement | undefined = undefined;
  protected PinElement: typeof google.maps.marker.PinElement | undefined = undefined;
  protected maps: {
    [id: string]: {
      element: HTMLElement;
      map: google.maps.Map;
  ...
  protected currMarkerId = 0;
  protected currTileOverlayId = 0;
  protected currCircleId = 0;
  protected currPolylineId = 0;
  protected currMapId = 0;
  ...
  protected async importGoogleLib(apiKey: string, region?: string, language?: string) {
